...
class KakuroSolver:
    ...
    def solver(self, boardM, row, col, prom):
        ...
        if prom == 0:
            ...
            for i in promList:
                for i in self.solver(board, row, col, i):
                    yield i
                    if i :
                        return
        else:
            #print("pr:", prom, "r", row, "c", col)
            #printLista(board)
            board = self.recalculateValues(board, row, col, prom)
            #print("after",board)
            #print("aff:",boardM)
...
board11 = [[[], [], [3, 0], [6, 0], [7, 0], [27, 0], [], [18, 0], [22, 0], [], []], [[], [7, 18], [3], [6], [7], [2], [1, 5], [4], [1], [16, 0], []], [[0, 7], [7], [], [6, 0], [0, 26], [4], [1], [9], [7], [5], [8, 0]], [[], [12, 0], [7, 6], [6], [0, 7], [7], [0, 19], [5], [2], [4], [8]], [[0, 16], [9], [7], [], [0, 5], [5], [3, 0], [0, 10], [3], [7], []], [[0, 3], [3], [5, 0], [12, 0], [0, 9], [8], [1], [0, 5], [5], [22, 0], [1, 0]], [[], [14, 8], [5], [3], [0, 3], [1], [2], [2, 14], [4], [9], [1]], [[0, 7], [7], [15, 9], [9], [20, 0], [24, 0], [12, 2], [2], [0, 2], [2], [6, 0]], [[0, 5], [2], [3], [10, 14], [5], [8], [1], [], [7, 13], [8], [5]], [[0, 36], [5], [8], [1], [7], [9], [6], [0, 11], [7], [3], [1]], [[], [0, 33], [4], [9], [8], [7], [5], [], [], [], []]]
