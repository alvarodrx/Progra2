                ...
                if gameList[i][j] == 0:
                    ...
                    if i == 0:
                        if (len(gameList) - j) > 10:
                            ...
                            newRowVal = self.getSumForNumer(numberOfCells)
                        ...
                        if (len(gameList) - j) > 10:
                            numberOfCells = random.randrange(1, 10)
                            while type(gameList[i][
                                                           j + numberOfCells + 1]) is list:  ## Evita que coloque una fila adyacente a una columna
                    ...
                    if (len(gameList) - i) > 10:
                        numberOfCells = random.randrange(1, 10)
                        newColVal = self.getSumForNumer(numberOfCells)
...
# lista = kakuroMaker(14).getNewGame()
